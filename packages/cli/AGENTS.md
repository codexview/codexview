...
This directory is the source of truth for `@codexview/cli`.

## Component scope

- Responsibility: CLI for rendering agent transcripts as compact Markdown context.
- Registry: public npm.
- Current consumer: CodexView CLI users; not currently a direct AgentWeb dependency.
...
5. The script builds adapters, pushes a cli-vX.Y.Z tag, and waits for publish-cli.yml to publish through GitHub Actions OIDC.
