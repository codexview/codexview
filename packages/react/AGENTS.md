...
This directory is the source of truth for `@codexview/react`.

## Component scope

- Responsibility: React components for rendering agent transcripts and tool activity.
- Registry: public npm.
...
5. The script pushes a vX.Y.Z tag and waits for release.yml to publish through GitHub Actions OIDC.
